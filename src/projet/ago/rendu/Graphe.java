...
public class Graphe {
    ...
    public final List getAdjacents() {
        return adjacents;
    }

    public final void setCouleur(int c) {
        couleur = c;
    }

    public final void setDistance(int d) {
        distance = d;
    }

    public void addAdjacent(Graphe g) {
        adjacents.add(g);
    }

    private void setPere(Graphe g) {
        pere = g;
    }
